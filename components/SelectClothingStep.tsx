    ...
    return (
      <div className="flex flex-col items-center p-4 w-full max-w-lg mx-auto">
        <div className="text-center mb-8 animate-fade-in-down">
            <h2 className="text-2xl font-bold text-gray-100">Step 2: Select Clothing</h2>
            <p className="text-gray-400 mt-2">
                First, choose the type of clothing, then provide an image of it.
            </p>
        </div>
        ...
        <button onClick={onBack} className="mt-8 flex items-center gap-2 text-gray-400 hover:text-blue-400 transition-colors animate-fade-in-up" style={{ animationDelay: '400ms' }}>
  ...
  return (
    <div className="flex flex-col items-center p-4 w-full max-w-md mx-auto animate-scale-in">
      <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-gray-100">Now, capture the clothing item</h2>
          <p className="text-gray-400 mt-2">
      ...
      <button onClick={() => setSelectedType(null)} className="mt-8 flex items-center gap-2 text-gray-400 hover:text-blue-400 transition-colors">
          <ArrowLeftIcon className="w-5 h-5" />
          <span>Change Clothing Type</span>
      </button>
    </div>
  );
};
